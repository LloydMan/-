...
class threeViewController: UIViewController {
    ...
    let question1Array:[String] = ["tarukimaru","tarukimaru","tarukimaru","tarukimaru","tarukimaru","tarukimaru","tarukimaru","tarukimaru","tarukimaru","tarukimaru","tarukimaru"]
...
//        let answer2Index = Int.random(in: 0...3)
        ...
        imageview.image = UIImage(named:question1Array[questionIndex])
